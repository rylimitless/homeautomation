...
class MQTT:
    ...
    sub_topics = [("620157506_pub", 0), ("620157506", 0), ("620157506_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620157506", self.update)
        self.client.message_callback_add("620157506_pub", self.toggle)
